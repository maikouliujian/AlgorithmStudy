...
/**
 * 0-1 背包问题，回溯算法  见 https://blog.csdn.net/qq_38046510/article/details/80061767
 * @author lj
 * @createDate 2019/7/9 19:41
 **/
public class BackTrack {
    ...
    public static void main(String[] args) {
        //测试
        int[] w1 = {0,15,25,40,20,15,24};   //重量
        int[] p1 = {0,10,5,20,2,14,23};   //价值
        int c1 = 30;  //最大重量！！！
        Loading(w1,p1,c1);
